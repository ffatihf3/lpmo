...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <span class="m-0 font-weight-bold text-success">Detail Pengaduan & Tanggapan</span>
  ...
  <a href="?url=lihat_pengaduan_tanggapan" class="btn btn-success btn-icon-split">
  ...
  <br>
    ...
    <?php 
      $sql=mysqli_query($koneksi,"select * from tanggapan where id_pengaduan='$_GET[id]'");
      $data=mysqli_fetch_array($sql);
      if ($sql)
      { 
    ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <br>
        <img height="150" src="../img/wave12.png"><textarea class="form-control" rows="7" name="isi_laporan" readonly=""><?php echo $data['tanggapan']; ?></textarea>
      </div>
